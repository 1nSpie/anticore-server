...
export type SmsTemplateMinAggregateOutputType = {
  kind: $Enums.SmsTemplateKind | null
  body: string | null
  updatedAt: Date | null
}
...
export type SmsTemplateWhereInput = {
  ...
  kind?: Prisma.EnumSmsTemplateKindFilter<"SmsTemplate"> | $Enums.SmsTemplateKind
...
export type SmsTemplateScalarWhereWithAggregatesInput = {
  ...
  kind?: Prisma.EnumSmsTemplateKindWithAggregatesFilter<"SmsTemplate"> | $Enums.SmsTemplateKind
...
export type SmsTemplateUpdateInput = {
  kind?: Prisma.EnumSmsTemplateKindFieldUpdateOperationsInput | $Enums.SmsTemplateKind
...
export type EnumSmsTemplateKindFieldUpdateOperationsInput = {
  set?: $Enums.SmsTemplateKind
}
...
export type SmsTemplateOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"kind" | "body" | "updatedAt", ExtArgs["result"]["smsTemplate"]>
...
export interface SmsTemplateDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const smsTemplateWithBodyOnly = await prisma.smsTemplate.findMany({ select: { body: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many SmsTemplates and only return the `body`
   * const smsTemplateWithBodyOnly = await prisma.smsTemplate.createManyAndReturn({
   *   select: { body: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more SmsTemplates and only return the `body`
   * const smsTemplateWithBodyOnly = await prisma.smsTemplate.updateManyAndReturn({
   *   select: { body: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface SmsTemplateFieldRefs {
  readonly kind: Prisma.FieldRef<"SmsTemplate", 'SmsTemplateKind'>
